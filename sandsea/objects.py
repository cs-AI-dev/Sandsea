...
class Plane:
    def __init__(self, vector):
        ...
        self.slope_yx = self.vector.y / self.vector.x
		self.slope_xy = self.vector.x / self.vector.y
		self.slope_zy = self.vector.z / self.vector.y
		self.slope_yz = self.vector.y / self.vector.z
		self.slope_zx = self.vector.z / self.vector.x
		self.slope_xz = self.vector.x / self.vector.z
        self.slope = self.slope_yx + self.slope_zy + self.slope_zx
